  ...
  return (
    <div className="mt-[-5%] relative xl:mt-[1%]">
      ...
      <div className="w-full marquee-wrapper xl:ml-[28%]">
        <div className="animate-marquee text-[150px] sm:text-7xl md:text-8xl xl:text-[300px] font-garamond font-bold text-gray-800 dark:text-[#EFB920] md:mt-14 md:mb-4 lg:mt-24">
          HANS&nbsp;HANS&nbsp;HANS&nbsp;HANS&nbsp;
        </div>
      </div>
              ...
              <li key={section}>
                <button
                  ...
                  className={`cursor-pointer transition-colors text-gray-700 hover:text-white tracking-wider ${
                    activeSection === section ? " dark:text-[#EFB920]" : " dark:text-[#EFB920]"
                  }`}
                >
                  {section.toUpperCase()}
                </button>
